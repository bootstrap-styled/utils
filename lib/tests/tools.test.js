...
describe('tools', function () {
  ...
  describe('createChainedFunction', function () {
    it('createChainedFunction should log warning if type of argument not a function"', function () {
      global.console = { warn: jest.fn() };
      expect(_typeof((0, _tools.createChainedFunction)(1, 2))).toEqual('function');
      expect(console.warn).toBeCalled();
    });
    it('createChainedFunction should return a new function', function () {
      var func1 = void 0;
      func1 = function func1(a, b) {
        return a + b;
      };
      var func2 = function func2(a, b) {
        return a - b;
      };
      func1 = (0, _tools.createChainedFunction)(func2, func1);
      expect(typeof func1 === 'undefined' ? 'undefined' : _typeof(func1)).toEqual('function');
    });
  });

  describe('pick', function () {
    it('pick should be a function', function () {
      expect(typeof _tools.pick === 'undefined' ? 'undefined' : _typeof(_tools.pick)).toEqual('function');
    });
    it('pick should returna  new object with the specified keys', function () {
      var obj = { a: 1, b: 2 };
      expect((0, _tools.pick)(obj, 'a')).toEqual({ a: 1 });
    });
  });
});